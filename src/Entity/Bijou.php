...
#[ApiFilter(OrderFilter::class, properties:['prixVente'=> 'ASC','prixLocation'=>'ASC'])]
...
class Bijou
{
    ...
    #[Groups(['bijou:list','bijou:item','categorie:list', 'categorie:item','location:list','location:item'])]
